      ...
      <form onSubmit={handleNew} className="space-y-3">
        ...
        <div className="flex gap-2 items-stretch">
          <input
            ...
            className="flex-1 min-w-0 px-3 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:border-blue-500"
          />
          <button
            type="submit"
            className="shrink-0 py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            New conversation
          </button>
          <button
            type="button"
            onClick={onContinue}
            className="shrink-0 py-2 px-4 bg-gray-100 text-gray-800 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400"
          >
            Continue
          </button>
        </div>
